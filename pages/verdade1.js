...
const Verdade1 = ({navigation}) => {

    let filtro = verdade.filter(verdade => verdade.Verdade === "Fazer sexo com a menstruação aumenta o risco de contrair e disseminar doenças");
     console.log(filtro)
