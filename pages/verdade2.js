...
const Verdade2 = ({navigation}) => {

    let filtro = verdade.filter(verdade => verdade.Verdade === "Fazer sexo com a menstruação não causa problemas para as mulheres");
     console.log(filtro)
